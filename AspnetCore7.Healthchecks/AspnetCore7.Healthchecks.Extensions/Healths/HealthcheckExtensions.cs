...
public static class HealthcheckExtensions
{
    ...
    public static IServiceCollection AddAppHealthChecks(this IServiceCollection services)
    {
        ...
        services.AddHealthChecks()
                ...
                .AddDatabaseCheck(HealthNames.SqlServerHealthcheck, default, HealthNames.DatabaseTags)
                .AddExternalServicesCheck(HealthNames.ExternalServiceHealthcheck, default, HealthNames.ExternalServicesTags);
